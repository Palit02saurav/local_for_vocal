...
export default function NewCategory({ type = "product" }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const imageUrl = image?.file ? await uploadImage(image.file) : "";
          ...
          <div className="np-col">
            <div className="np-card">
              ...
              <div className="np-field">
                ...
                <input
                  type="text"
                  placeholder="Enter category name (e.g., Handicrafts)"
                  value={form.name}
          ...
          <div className="np-col">
            <div className="np-card">
              ...
              <div className="np-field">
                ...
                <span className="np-hint">Inactive categories won't appear in the Shop's category filter</span>
              </div>
            </div>
          </div>
        </div>
