    ...
    <main className="pp-page">
      <div className="pp-header">
        <div>
          ...
          <p>All service categories in your marketplace.</p>
        </div>
        <Link href="/categories/new-service" className="pp-add-btn">
      ...
      <div className="pp-table-wrapper">
        {loading ? (
          <div className="pp-state-msg">Loading service categories…</div>
        ) : error ? (
          <div className="pp-state-msg pp-state-error">
            {error} <button className="pp-retry-btn" onClick={loadCategories}>Retry</button>
          </div>
        ) : filtered.length === 0 ? (
          <div className="pp-state-msg">No service categories found.</div>
        ) : (
